...
exports.summarizeSlackMessages = summarizeSlackMessages;
exports.summarizeMergeRequests = summarizeMergeRequests;
// src/summarize.ts
 ...
 */
function formatActivityForSummarization(activity) {
 ...
 */
async function summarizeSlackMessages(activity) {
    try {
        ...
        const response = await withTimeout(openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are a helpful assistant that summarizes Slack activity. Create a concise summary of the user's Slack activity in the given time period. Focus on the main topics of discussion, any important information shared, and general themes of conversation. Group similar activities together.",
                },
                {
                    role: "user",
 ...
 */
function formatMergeRequestsForSummarization(mergeRequests) {
 ...
 */
async function summarizeMergeRequests(mergeRequests) {
    try {
        ...
        const response = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are a helpful assistant that summarizes GitLab merge request activity. Create a concise summary of the user's merge requests in the given time period. Focus on the main topics of the merge requests, any important changes, and general themes. Group similar requests together.",
                },
                {
                    role: "user",
